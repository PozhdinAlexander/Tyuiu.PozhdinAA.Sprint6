...
using Tyuiu.PozhdinAA.Sprint6.Task4.V18.Lib;
using System.IO;

namespace Tyuiu.PozhdinAA.Sprint6.Task4.V18
{
    public partial class FormMain : Form
    {
        ...
        private void buttonDone_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                this.chartFunction_PAA.ChartAreas[0].AxisX.Title = "Ось X";
                this.chartFunction_PAA.ChartAreas[0].AxisY.Title = "Ось Y";
                ...
                {
                    this.chartFunction_PAA.Series[0].Points.AddXY(startStep, valueArray[i]);
        ...
        {
            MessageBox.Show("Таск 4 выполнил студент группы АСОиУБ-23-1 Пождин Александр Андреевич ", "Сообщение");
        }
